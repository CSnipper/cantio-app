...
public class DatabaseService
{
    ...
    {
        await using var db = new CantorDbContext();
    ...
    {
        using var db = new CantorDbContext();
        ...
        return new DisplaySettings
        {
            ...
            TextMarginH = Get("text_margin_h", 80.0, v => double.TryParse(v, out var d) ? d : 80),
            TextMarginV = Get("text_margin_v", 60.0, v => double.TryParse(v, out var d) ? d : 60),
        };
    }
}